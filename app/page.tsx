      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-4 py-4 flex justify-between items-center">
          <div>
            ...
            <h1 className="text-lg font-bold text-gray-900">渋谷（道玄坂）</h1>
          </div>
      ...
      <main>
        <section className="bg-gray-50 py-20 px-4">
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-sm text-gray-500 mb-3">Shibuya Dogenzaka · Tokyo</p>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 leading-tight mb-6">{hotel.catchcopy.ja}</h2>
            <p className="text-gray-600 text-lg mb-4">渋谷駅（JR・東急・東京メトロ各線）徒歩5分・神泉駅徒歩3分。35㎡の一棟貸切・最大5名の民泊。</p>
            <p className="text-gray-500 text-base mb-8">ダブルベッド＋ソファーベッド・Nintendo Switch・キッチン完備。渋谷・道玄坂エリアのグループ旅行に最適。</p>
        ...
        <section className="py-10 px-4 bg-white border-b border-gray-100">
          <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            <div className="p-4"><p className="text-3xl font-bold text-gray-900">35㎡</p><p className="text-sm text-gray-500 mt-1">一棟貸切</p></div>
            <div className="p-4"><p className="text-3xl font-bold text-gray-900">最大5名</p><p className="text-sm text-gray-500 mt-1">グループ利用OK</p></div>
            <div className="p-4"><p className="text-3xl font-bold text-gray-900">徒歩5分</p><p className="text-sm text-gray-500 mt-1">渋谷駅</p></div>
            <div className="p-4"><p className="text-3xl font-bold text-gray-900">渋谷・道玄坂</p><p className="text-sm text-gray-500 mt-1">繁華街すぐ</p></div>
          </div>
        </section>
        ...
        <section id="rooms" className="py-14 px-4 bg-gray-50">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-center text-gray-500 mb-10">35㎡一棟貸切。ダブルベッド＋ソファーベッドで最大5名。</p>
        ...
        {latestPosts.length > 0 && (
          <section className="py-14 px-4 bg-white">
            <div className="max-w-5xl mx-auto">
              ...
              <p className="text-center text-gray-500 mb-10">渋谷・道玄坂エリアの最新情報</p>
        ...
        <section id="booking" className="py-20 px-4 bg-gray-900 text-white">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-2xl font-bold mb-3">渋谷駅5分。35㎡一棟貸切・最大5名で渋谷エリアを満喫</h2>
