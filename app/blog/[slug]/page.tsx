  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-16">
      ...
      <div className="mt-16 bg-gray-900 text-white rounded-2xl p-8 text-center">
        <p className="font-bold text-lg mb-2">ぷらっとハウス渋谷（道玄坂）</p>
        <p className="text-gray-400 text-sm mb-6">渋谷駅5分・神泉駅3分・ファミリールーム・最大5名</p>
        <a
          href="https://beds24.com/booking.php?propid=240502&referer=BookingLink"
